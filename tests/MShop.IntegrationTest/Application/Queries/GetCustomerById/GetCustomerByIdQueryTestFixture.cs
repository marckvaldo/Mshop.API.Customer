...
{
    public class GetCustomerByIdQueryTestFixture : IntegrationBaseFixture
    {
        ...
        public GetCustomerByIdQueryTestFixture():base()
        {
        ...
        protected GetCustomerByIdQuery RequestValid(Guid id)
        {
