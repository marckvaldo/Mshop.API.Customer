...
{
    public class GetCustomerByEmailQueryTestFixture : IntegrationBaseFixture
    {
        ...
        public GetCustomerByEmailQueryTestFixture():base()
        {
        ...
        protected GetCustomerByEmailQuery RequestValid(string email)
        {
            return new GetCustomerByEmailQuery(email);
        }
    }
}
